...
function() {
	...
	function g(t, a) {
		var o = 1 < arguments.length && void 0 !== a && a;
		if (t.classList.contains(y.tabButton)) {
			...
			if (n.forEach(function(t) {
			...
			}), c.classList.add(y.tabButtonActive), !o) {
				if (m.persist) {
				...
				if (m.sync) {
					...
					window.scrollBy(0, 0 - (i - r.offsetTop)),
					0 < l.indexOf(e) && l.splice(l.indexOf(e), 1),
					0 !== l.indexOf(e) && (l.unshift(e), sessionStorage.setItem("*", JSON.stringify(l)))
				}
			}
		}
	}
	function s() {
		...
		a = t && ".".concat(y.tabBlock, " #").concat( - 1 < t.indexOf("%") ? decodeURIComponent(t) : t);
		if (t && document.querySelector(a)) {
			var o, c = document.querySelector("#".concat(t));
			if (c.closest) o = c.closest(".".concat(y.tabContent));
			else for (o = c.parentNode; o !== document.body && !o.classList.contains("".concat(y.tabContent));) o = o.parentNode;
			g(o.previousElementSibling)
		}
	}
	...
	Object.keys(window.$docsify.tabs).forEach(function(t) {
	...
	}), window.$docsify.tabs.version = "1.4.4", (m.tabComments || m.tabHeadings) && (window.$docsify.plugins = [].concat(function(t, a) {
		var o = !1;
		t.beforeEach(function(t) {
			return (o = p.tabBlockMarkup.test(t)) && (t = function(d) {
				for (var b, f, o = d.match(p.codeMarkup) || [], t = o.map(function(t, a) {
					var o = "\x3c!-- ".concat(u, " CODEBLOCK").concat(a, " --\x3e");
					return d = d.replace(t,
					function() {
						return o
					}),
					o
				}), l = m.theme ? "".concat(y.tabBlock, "--").concat(m.theme) : "", a = function() {
					var o = b[0],
					t = "",
					a = "",
					c = m.tabComments && p.tabCommentMarkup.test(o),
					e = m.tabHeadings && p.tabHeadingMarkup.test(o),
					s = b[1],
					r = b[2],
					n = b[4];
					if (c || e) {
						t = "\x3c!-- ".concat(u, ' <div class="').concat([y.tabBlock, l].join(" "), '"> --\x3e'),
						...
						}; null !== (f = (m.tabComments ? p.tabCommentMarkup.exec(o) : null) || (m.tabHeadings ? p.tabHeadingMarkup.exec(o) : null));) i()
					}
					o = (o = o.replace(r,
					function() {
						return t
				...
				}; null !== (b = p.tabBlockMarkup.exec(d));) a();
		...
		t.afterEach(function(t, a) {
			o && (t = function(o) {
				...
				}; null !== (c = p.commentReplaceMarkup.exec(o));) t();
				return o
			} (t)),
			a(t)
		}),
		t.doneEach(function() {
			var t, a, c, e;
			o && (t = document.querySelector(".".concat(y.tabsContainer)), a = t ? Array.apply(null, t.querySelectorAll(".".concat(y.tabBlock))) : [], c = JSON.parse(sessionStorage.getItem(window.location.href)) || {},
			e = JSON.parse(sessionStorage.getItem("*")) || [], s(), a.forEach(function(a, t) {
				var o = a.querySelector(".".concat(y.tabButtonActive));
				o || (m.sync && e.length && (o = e.map(function(t) {
					return a.querySelector(".".concat(y.tabButton, '[data-tab="').concat(t, '"]'))
				}).filter(function(t) {
					return t
				})[0]), !o && m.persist && (o = a.querySelector(".".concat(y.tabButton, '[data-tab="').concat(c[t], '"]'))), (o = o || a.querySelector(".".concat(y.tabButton))) && o.classList.add(y.tabButtonActive))
			}))
		}),
		t.mounted(function() {
