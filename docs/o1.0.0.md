...
# [ 静态成员 ][ 标准函数 ] this: 指向函数调用者 ( 因此 this: TClass )
TClass.Show2 = function() {
...
>
>- [`A`] 在`JS`中，<span style='color:Blue'>[ 构造函数 ]</span> 都有一个`prototype`属性 <span style='color:red'>[ 指向其原型对象 ]</span>
>
